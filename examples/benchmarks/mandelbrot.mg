...
fun render(min_real, max_real, min_imag, max_imag, should_print) {
    let width = WIDTH;
    let height = HEIGHT;
    // let width = 3200;
    // let height = 720;
...
fun zoom_render(x_center, y_center, zoom, should_print) {
    ...
    render(x_min, x_max, y_min, y_max, should_print);
}



// Example render call with zoomed-in region
zoom_render(-0.743643887037151, 0.131825904205330, 100.0, false);
// zoom_render(-2.0, 1.0, 1.0, false); // Full view
// zoom_render(0.001643721971153, -0.822467633298876, 1000.0, false);
// zoom_render(-1.75, 0.0, 100.0, false);
// zoom_render(-0.745428, 0.113009, 300.0, false);
// zoom_render(-0.122561, 0.744861, 500.0, false);
// zoom_render(-0.743643135, 0.131825963, 10000.0, false);
// zoom_render(-0.7463, 0.1102, 200.0, false);


putsln("Done rendering!");